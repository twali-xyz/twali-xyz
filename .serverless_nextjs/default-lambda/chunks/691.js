...
const getDynamoDBClient = ()=>{
    ...
    const client = process.env.LOCAL_DYNAMO_DB_ENDPOINT ? new AWS.DynamoDB.DocumentClient(...options, process.env.LOCAL_DYNAMO_DB_ENDPOINT) : new AWS.DynamoDB.DocumentClient(options);
    return client;
};
module.exports = {
    /**
