...
var schedule = __webpack_require__(46853);
var Queue = __webpack_require__(74536);
var util = __webpack_require__(92553);
...
var bluebird = __webpack_require__(77610)();
...
module.exports = function(Promise) {
var errors = __webpack_require__(4836);
var async = __webpack_require__(12631);
...
var keys = (__webpack_require__(67170).keys);
...
var async = __webpack_require__(12631);
var Warning = (__webpack_require__(4836).Warning);
var util = __webpack_require__(92553);
...
var es5 = __webpack_require__(67170);
...
var tryConvertToPromise = __webpack_require__(11314)(Promise, INTERNAL);
var PromiseArray =
    __webpack_require__(49529)(Promise, INTERNAL,
                                    tryConvertToPromise, apiRejection);
var CapturedTrace = __webpack_require__(62075)();
...
__webpack_require__(90804)(Promise, PromiseArray);
__webpack_require__(37111)(Promise, INTERNAL, tryConvertToPromise, apiRejection);
__webpack_require__(56217)(Promise, INTERNAL, tryConvertToPromise);
__webpack_require__(80833)(Promise, NEXT_FILTER, tryConvertToPromise);
__webpack_require__(47573)(Promise);
__webpack_require__(45739)(Promise);
__webpack_require__(8302)(Promise, PromiseArray, tryConvertToPromise, INTERNAL);
Promise.version = "2.11.0";
Promise.Promise = Promise;
__webpack_require__(49766)(Promise, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL);
__webpack_require__(57420)(Promise);
__webpack_require__(52765)(Promise, apiRejection, tryConvertToPromise, createContext);
__webpack_require__(72251)(Promise, apiRejection, INTERNAL, tryConvertToPromise);
__webpack_require__(36603)(Promise);
__webpack_require__(77326)(Promise);
__webpack_require__(77441)(Promise, PromiseArray, tryConvertToPromise, apiRejection);
__webpack_require__(3675)(Promise, INTERNAL, tryConvertToPromise, apiRejection);
__webpack_require__(40268)(Promise, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL);
__webpack_require__(51148)(Promise, PromiseArray);
__webpack_require__(78030)(Promise, PromiseArray, apiRejection);
__webpack_require__(74180)(Promise, INTERNAL);
__webpack_require__(62447)(Promise);
__webpack_require__(69038)(Promise, INTERNAL);
__webpack_require__(24846)(Promise, INTERNAL);
__webpack_require__(69345)(Promise, INTERNAL);
...
var THIS = {};
var util = __webpack_require__(92553);
var nodebackForPromise = (__webpack_require__(67338)._nodebackForPromise);
var withAppended = util.withAppended;
var maybeWrapAsError = util.maybeWrapAsError;
var canEvaluate = util.canEvaluate;
var TypeError = (__webpack_require__(4836).TypeError);
...
var isArray = (__webpack_require__(92553).isArray);
...
var util = __webpack_require__(92553);
var RangeError = (__webpack_require__(4836).RangeError);
var AggregateError = (__webpack_require__(4836).AggregateError);
var isArray = util.isArray;
...
module.exports = function (Promise, apiRejection, tryConvertToPromise,
    createContext) {
    var TypeError = (__webpack_require__(4836).TypeError);
    var inherits = (__webpack_require__(92553).inherits);
    var PromiseInspection = Promise.PromiseInspection;
...
var _           = __webpack_require__(27642);
var Promise     = __webpack_require__(79879);
var createError = __webpack_require__(21786);
var http        = __webpack_require__(13685);
var needle      = Promise.promisifyAll(__webpack_require__(45174));
var pkg         = __webpack_require__(88408);
...
function ClearbitClient (config) {
  ...
  this.Company = (__webpack_require__(22902).Company)(this);
  this.Person = (__webpack_require__(79431).Person)(this);
  this.Enrichment = (__webpack_require__(70887).Enrichment)(this);
  this.Discovery = (__webpack_require__(59081).Discovery)(this);
  this.Prospector = (__webpack_require__(68317).Prospector)(this);
  this.Reveal = (__webpack_require__(49924).Reveal)(this);
  this.Risk = (__webpack_require__(58262).Risk)(this);
  this.NameToDomain = (__webpack_require__(19245).NameToDomain)(this);
  this.Watchlist = (__webpack_require__(53704).Watchlist)(this);
  this.WatchlistCandidate = (__webpack_require__(53704).WatchlistCandidate)(this);
  this.WatchlistEntity = (__webpack_require__(53704).WatchlistEntity)(this);
  this.WatchlistIndividual = (__webpack_require__(53704).WatchlistIndividual)(this);
}
...
var resource = __webpack_require__(39297);
...
var Client = __webpack_require__(57535);
...
(function () {
  ...
  var assign = __webpack_require__(95081);
  var vary = __webpack_require__(44824);
...
// Boilerplate UMD definition block...
  ...
  } else { var createError, lastcreateError, root; }
});
...
var createHash = (__webpack_require__(6113).createHash);
...
module.exports = function(charset) {
  try {
    if (!iconv) iconv = __webpack_require__(4713);
  } catch(e) {
    /* iconv not found */
  }
...
var readFile = (__webpack_require__(57147).readFile),
    basename = (__webpack_require__(71017).basename);
...
var fs          = __webpack_require__(57147),
    ...
    stream      = __webpack_require__(12781),
    stringify   = (__webpack_require__(30156)/* .build */ .J),
    multipart   = __webpack_require__(26504),
    auth        = __webpack_require__(58210),
    parsers     = __webpack_require__(97289),
    decoder     = __webpack_require__(69790);

//////////////////////////////////////////
// variabilia
//////////////////////////////////////////

var version     = (__webpack_require__(93767)/* .version */ .i8),
...
try {
  ...
  var xml2js = __webpack_require__(2689);
...
(function() {
  ...
  builder = __webpack_require__(81885);

  defaults = (__webpack_require__(42662).defaults);
...
(function() {
  ...
  sax = __webpack_require__(30462);

  events = __webpack_require__(82361);

  bom = __webpack_require__(50606);

  processors = __webpack_require__(86264);
...
(function() {
  ...
  defaults = __webpack_require__(42662);

  builder = __webpack_require__(34744);

  parser = __webpack_require__(69811);
...
(function() {
  ...
  XMLNode = __webpack_require__(62596);
...
(function() {
  ...
  isObject = (__webpack_require__(13694).isObject);
...
(function() {
  ...
  XMLDTDAttList = __webpack_require__(18714);

  XMLDTDEntity = __webpack_require__(53864);

  XMLDTDElement = __webpack_require__(8013);

  XMLDTDNotation = __webpack_require__(5806);
...
(function() {
  ...
  isPlainObject = (__webpack_require__(13694).isPlainObject);

  XMLNode = __webpack_require__(62596);

  XMLStringifier = __webpack_require__(95105);

  XMLStringWriter = __webpack_require__(81482);
...
(function() {
  ...
  ref = __webpack_require__(13694), isObject = ref.isObject, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject;

  XMLElement = __webpack_require__(20361);

  XMLCData = __webpack_require__(30576);

  XMLComment = __webpack_require__(34179);

  XMLRaw = __webpack_require__(69330);

  XMLText = __webpack_require__(33882);

  XMLProcessingInstruction = __webpack_require__(59734);

  XMLDeclaration = __webpack_require__(49459);

  XMLDocType = __webpack_require__(95649);
  ...
  XMLAttribute = __webpack_require__(26371);
...
(function() {
  ...
  ref = __webpack_require__(13694), isObject = ref.isObject, isFunction = ref.isFunction;
...
(function() {
  ...
  ref = __webpack_require__(13694), isObject = ref.isObject, isFunction = ref.isFunction, isEmpty = ref.isEmpty;
...
(function() {
  ...
  XMLWriterBase = __webpack_require__(65190);
...
(function() {
  ...
  ref = __webpack_require__(13694), assign = ref.assign, isFunction = ref.isFunction;

  XMLDocument = __webpack_require__(65924);

  XMLDocumentCB = __webpack_require__(21719);

  XMLStringWriter = __webpack_require__(81482);

  XMLStreamWriter = __webpack_require__(40590);
